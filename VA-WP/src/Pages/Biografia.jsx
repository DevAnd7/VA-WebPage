    ...
    return (
        ...
        <div className="d-flex flex-column gap-2">
            ...
            <CardSeccion titulo="Entrega Plena al Arte y la Música"
                ...
                Ya instalado en Barquisimeto, abrió la galería “Aguatinta”, un pequeño pero vibrante espacio creativo ubicado dentro de la reconocida tienda Maxxis, que pronto se convirtió en el núcleo de su actividad artística.
            ...
            <CardSeccion titulo="Exploraciones Creativas"
                ...
                “Desde la belleza externa del humano, voy en la búsqueda de la belleza interna.”
            ...
            <CardSeccion titulo="La Música: Una Carrera Prolífica y Cultural"
                img=""
                caption=""
                texto={`La música, siempre presente en su vida, fue otro de los pilares fundamentales de su obra. Virgilio Arrieta compuso más de trescientas canciones que han sido interpretadas por artistas nacionales e internacionales como Simón Díaz, Oscar D’León, Serenata Guayanesa, María Rivas, Neguito Borjas, Gualberto Ibarreto y muchos otros. Sus letras, cargadas de lirismo y sensibilidad, celebran la cultura y las tradiciones venezolanas.
                
                Producciones como “El Canto del Pueblo II”, “Lo Nuestro es lo Mejor II”, “Agua Bendita”, “Corazón Venezolano”, “El Tiquititaqui del Tambor”, “Falta por Cantarle a Tanta Gente”, “El Amor es la Vida”, “Arcilla Camino y Sol”, y “Si Así Llueve Que No Escampe” destacan entre sus contribuciones al acervo musical venezolano. Estas producciones no solo muestran su versatilidad como compositor, sino también su capacidad para abordar temas que resuenan profundamente con la identidad nacional.`}
            ...
            <CardSeccion titulo='“Lo Nuestro es lo Mejor”: Un Tributo a la Música Venezolana'
                ...
                “Lo Nuestro es lo Mejor” no solo destacó el legado de Arrieta como compositor, sino que también subrayó su compromiso con la cultura local, convirtiéndose en un testimonio del impacto de su obra en la identidad musical de Venezuela.`}
            ...
            <CardSeccion titulo="Un Legado Artístico y Humano"
                ...
                texto={`En su faceta como artista plástico, Arrieta exploró diversas formas de expresión, llevando su obra más allá del caballete para crear murales de gran escala, incluyendo uno que supera los 224 m². Su arte, profundamente humanista y poético, ha sido expuesto en Latinoamérica, Estados Unidos y Europa, logrando resonar con audiencias de distintas culturas.

                La unión de sus talentos como pintor, compositor y músico lo convierte en un creador integral.

                Según sus palabras:

                “Mis dibujos se convierten en canciones, y mis canciones se llenan de color. Es una simbiosis necesaria e inevitable.”
            ...
            <CardSeccion titulo="Algunas distinciones"
                img=""
                caption=""
                texto={`1999 - Orden Jacinto Lara, en su primera clase, otorgada por el clero y el Ejecutivo Nacional.
                2001 - Embajador cultural de Lara.
                2006 - Epónimo de todas las carreras de la XXV promoción de la Universidad Yacambú.
                2007 - Recibe la Orden Mario Briceño Iragorri, como artista e hijo ilustre, Maracay Aragua.
                2015 - Recibe Orden Juan Guillermo Iribarren, en su primera clase.
                2024 - Recibe Medalla Institucional de la Universidad Centroccidental Lisandro Alvarado (UCLA)-Barquisimeto, por su excelente contribución a la cultura en nuestra región y el país.
